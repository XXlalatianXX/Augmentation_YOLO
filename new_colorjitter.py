...
brightness_range = (0.5, 1.5)  # Range of brightness factor for color jitter
saturation_range = (0.5, 1.5)  # Range of saturation factor for color jitter
...
def process_image(image_path):
    ...
    if os.path.isfile(annotation_path):
        ...
        # Random saturation augmentation
        ...
        new_filename = os.path.splitext(filename)[0] + "_augcoloJit"
